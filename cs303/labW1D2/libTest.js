...
const exp = require("./books.js");  //with node need the name of your file with your functions here
...
describe("library", function () {
    ...
    it("find titles", function () {
        assert.deepStrictEqual(exp.findTitles(), titles);
    });

    it("find authors", function () {
        assert.deepStrictEqual(exp.findAuthors(), authors);
    });

    it("find ids", function () {
        assert.deepStrictEqual(exp.findIDs(), ids);
    });
